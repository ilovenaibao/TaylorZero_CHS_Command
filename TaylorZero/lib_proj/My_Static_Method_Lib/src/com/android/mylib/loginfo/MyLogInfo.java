package com.android.mylib.loginfo;
...
public class MyLogInfo {
	 ...
	 * log tag
	 */
	private String tag = "MyLogInfo";// application name
	/**
	 * debug or not
	 */
	private static boolean debug = true;

	private static MyLogInfo instance = new MyLogInfo();

	public static MyLogInfo getMyLogInfo() {
		return instance;
	}
