...
public class ListViewTest extends ListActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			PackageInfo pi = getPackageManager().getPackageInfo(
					"com.android.taylorzero", PackageManager.GET_ACTIVITIES);
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		intent.setClassName(this,
				"com.android.taylorzero.login.pic.popdirlist.TestBedDSLV");
		startActivity(intent);
	}

	private class MyAdapter extends ArrayAdapter<ActivityInfo> {
		MyAdapter() {
			super(ListViewTest.this, R.layout.launcher_item,
					R.id.activity_title, mActivities);
		}
