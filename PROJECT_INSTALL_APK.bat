...
:: start Install a this apk file

echo.
echo Installing %ProjectPackage_Name%      ...
call adb.exe install -r %Project_Path%\%ProjectOutApk_Name%
if errorlevel 1 goto ERROR
goto EXIT_SUCCESS
...
:EXIT_SUCCESS
echo.
echo Install %ProjectOutApk_Name% is Success!
call adb.exe shell am start -n %ProjectPackage_Name%/%Start_Activity_Name%
if errorlevel 1 goto Start_Activity_Error
goto EXIT_END
